...
# This tells Django it's safe to accept login forms from these addresses.
...
EMAIL_HOST_PASSWORD = 'dsnz axgc ghek kgpp'      # <--- Paste the 16-char App Password here (spaces don't matter)
